...
for (dirpath, dirnames, filenames) in os.walk('/app/assets/img/users/'):
#for (dirpath, dirnames, filenames) in os.walk('/home/pi/storage/azure/assets/img/users/'):
    known_faces_filenames.extend(filenames)
    break

for filename in known_faces_filenames:
    face = face_recognition.load_image_file('/app/assets/img/users/' + filename)
    #face = face_recognition.load_image_file('/home/pi/storage/azure/assets/img/users/' + filename)
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index]:
                ...
                # * ---------- SEND data to API --------- *
                r = requests.post(
                    url='http://localhost:5001/receive_data', json=json_to_export)
